...
-- Listage des données de la table cinema sql.casting : ~19 rows (environ)
...
-- Listage des données de la table cinema sql.film : ~12 rows (environ)
...
-- Listage des données de la table cinema sql.genre_film : ~12 rows (environ)
...
-- Listage des données de la table cinema sql.realisateur : ~10 rows (environ)
...
-- Listage des données de la table cinema sql.role : ~26 rows (environ)
