...
CREATE TABLE IF NOT EXISTS `actor` (
  ...
  KEY `id_personne` (`id_person`) USING BTREE,
  CONSTRAINT `actor_ibfk_1` FOREIGN KEY (`id_person`) REFERENCES `person` (`id_person`)
) ENGINE=InnoDB AUTO_INCREMENT=242 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Listage des données de la table cinema.actor : ~22 rows (environ)
INSERT INTO `actor` (`id_actor`, `id_person`, `picture`) VALUES
...
CREATE TABLE IF NOT EXISTS `casting` (
  ...
  PRIMARY KEY (`id_movie`,`id_actor`,`id_role`) USING BTREE,
  KEY `id_role` (`id_role`),
  KEY `id_acteur` (`id_actor`) USING BTREE,
...
-- Listage des données de la table cinema.director : ~10 rows (environ)
INSERT INTO `director` (`id_director`, `id_person`, `picture`) VALUES
...
CREATE TABLE IF NOT EXISTS `genre_film` (
  ...
  PRIMARY KEY (`id_movie`,`id_genre`) USING BTREE,
  KEY `id_genre` (`id_genre`),
  CONSTRAINT `genre_film_ibfk_1` FOREIGN KEY (`id_movie`) REFERENCES `movie` (`id_movie`),
  CONSTRAINT `genre_film_ibfk_2` FOREIGN KEY (`id_genre`) REFERENCES `genre` (`id_genre`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Listage des données de la table cinema.genre_film : ~12 rows (environ)
INSERT INTO `genre_film` (`id_movie`, `id_genre`) VALUES
	(1, 1),
	(2, 1),
	(3, 2),
	(4, 3),
...
CREATE TABLE IF NOT EXISTS `movie` (
  ...
  KEY `id_realisateur` (`id_director`) USING BTREE,
  CONSTRAINT `movie_ibfk_1` FOREIGN KEY (`id_director`) REFERENCES `director` (`id_director`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Listage des données de la table cinema.movie : ~12 rows (environ)
INSERT INTO `movie` (`id_movie`, `titre`, `annee_sortie_fr`, `duree`, `synopsis`, `note`, `id_director`, `picture`) VALUES
...
-- Listage des données de la table cinema.person : ~35 rows (environ)
INSERT INTO `person` (`id_person`, `nom`, `prenom`, `sexe`, `date_naissance`) VALUES
